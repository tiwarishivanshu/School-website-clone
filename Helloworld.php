...
<body>
    <div class="container-fluid" id="main_body">  
            <div class="row" id="logo">
                ...
                <div class="col-sm-4 col-md-3 col-lg-3"><img src="logo.png" width="auto" height="auto"></div>
            ...
            <div class="row" id="search">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    ...
                    <img src="search.png" height="15px" weidth="15px">  
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-10 col-sm-10">
                <div class="row" id="menu">
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">Home</a></p></div>
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">About us</a></p></div>
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">FPSA</a></p></div>
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">News</a></p></div>
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">Parents</a></p></div>
                    <div class="col-sm-2 col-lg-2 col-md-2"><p><a href="#">Contact</a></p></div>  
                </div>
            </div>
            <div class="col-lg-3 col-md-1 col-sm-1"></div>
        </div>
